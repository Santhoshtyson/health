...
export const policies: Policy[] = [
  ...
  },
  {
    ...
    features: {
      ...
      waitingPeriods: { text: 'Delivery: 12/24 months. Specific Diseases: 24 months. PED: 24 months. Cancer Cover: 180 Days' },
      exclusions: { text: 'Cosmetic surgery, self-inflicted injuries, adventure sports etc.' },
  ...
  },
  {
    ...
    features: {
      ...
      entryAge: { text: 'Individual : 91 days to Max 75 Years, Dependent Children: Min 91 Days to  25 years, Floater : Min 18 Years to Max 75 Years, Dependent Children: Min 16 Days to 25 years.' },
      sumInsured: { text: '10L to 2 Crore' },
      premium: { text: 'Starts from Rs.9903/year for 10 L cover' },
      hospitalization: { text: 'In-patient care up to SI, 10L to 25L: Any room (except suit room)/ 50L to 2Cr Any room' },
      ...
      cashbenefits: { text: 'Up to Rs. 5000/- per policy year for Treatment in Valuable Service Providers Network, Rs. 1000/- Cash Benefit for in-patient hospitalization for each continuous and completed period of 24 hours of stay shared accommodation' },
  ...
  },
  {
    ...
    features: {
      ...
      FreezeyourAge: { text: 'Insured will pay premium as per the entry age till the first claim or till 55yrs of age' },
      ...
      GracePeriodCover: { text: 'Coverage available during the grace period for policies due for renewa' },
      ...
      FutureShield: { text: 'Provides continuity benefit for all waiting periods served by the insured member to the spouse added if added with 120day from date of Marriage' },
      Limitlesscare: { text: 'One unlimited claim cover in a lifetime of the base policy for in patient/day care treatment.' },
