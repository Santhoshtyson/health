...
export const policies: Policy[] = [
  // --- Star Health Policies ---
  {
    ...
    features: {
      ...
      cumulativeBonus: { text: 'For SI 5L: 50% SI every claim-free year, max up to 100% SI ; For 7.5L & above: 100% SI every claim-free year, max upto 100% SI' },
      chronicDisease: { text: 'Optional Buy-back for PED reduces waiting period from 36 to 12 months.' },
      maternity: { text: 'Covered up to ₹1L (Caesarean) / ₹50k (Normal) for SI ≥ ₹50L. Waiting Period: 24 months.' },
      newbornCover: { text: 'Covered up to 2L (for SI 50L & Above) from Day 1, including congenital disorders. Vaccinations up to 10k.' },
      wellness: { text: 'Star Wellness Program: Earn reward points for up to 10% premium discount.' },
      opdCover: { text: 'Out Patient consultation expenses incurred in a Networked Facility for other than Dental and Ophthalmic treatments, up to Rs.300 per consultation max limit as per policy clause. Out-patient Dental & Ophthalmic: Covered up to 15k after a 3-year block.' },
      otherBenefits: { text: 'In-built Accidental Death & PTD Cover. Bariatric Surgery Cover (3yrs waiting period)), Modern Treatment coverage based on sub limits. Organ donor expenses coverage' },
      ...
      usps: { text: 'Truly Comprehensive for 2A+3C family size. In-built Personal Accident cover, robust Maternity & Newborn cover. Generous & Fast Cumulative Bonus (100% in one year). Same illness restoration.' },
      annualhealthcheckup: { text: 'Available every claim-free year up to ₹5,000 in any network facility' },
      hospitalcashbenefit: { text: 'Available for up to ₹2,500 per day to a max of 7 days per occurrence and 120 days per policy year' },
      hometreatment: { text: 'Yes available' },
    },
  },
  {
    id: 'star-young',
    ...
    features: {
      ...
      sumInsured: { text: 'Floater: 5L to 1Cr ; Individual: 3L to 1Cr' },
      premium: { text: 'Lower premiums targeting younger customers.' },
      hospitalization: { text: 'Room Rent: Single Private A/C Room (Actuals)' },
      prePostHosp: { text: '60 days pre / 90 days post' },
      dayCare: { text: 'All day care procedures covered.' },
      restoreBenefit: { text: 'Up to 100% Automatic Restoration Once in ever Policy Year and can be utilized for all claims.' },
      ...
      maternity: { text: 'Payable up to ₹30,000/delivery to a max of 2 deliveries, subject to a waiting period of 3 years (GOLD PLAN)' },
      newbornCover: { text: 'Not covered.' },
      wellness: { text: 'The Insured can earn reward points and avail premiumdiscount up to 10%on the renewal premium by enrolling and achieving the wellness goal.' },
      opdCover: { text: 'Not Covered' },
      otherBenefits: { text: 'RTA, 25% of sum insured subject to a max up/ Discount of Early Entry/E Medical Opinion' },
      waitingPeriods: { text: 'Initial: 30 days. Specific Diseases: 12 months. Pre-Existing Diseases (PED): 12 months.' },
      exclusions: { text: 'Cosmetic surgery, self-inflicted injuries, adventure sports etc' },
      usps: { text: 'Low Waiting Periods: Only 12 months for PEDs ,Automatic Restoration (Up to 100%,Once in ever Policy Year),Health Check-up (available after each policy year)' },
      homecaretreatment: { text: 'Yes available' },
      noclaimbonus: { text: '20% for each claim free year subject to a maximum of 100%' },
      annualhealthcheckup: { text: 'Available every year up to the limits specified based on the policy type' },
      hospitalcashbenefit: { text: 'Available for up to ₹1,000 per day to a max of 7 days per occurrence and 14 days per policy year (GOLD PLAN)' },
      waitingperiods: { text: 'Initial: 30 days. Specific: 12 months. PED: 12 months. Maternity: 36 months' },
    },
  },
  {
    id: 'star-fho',
    ...
    features: {
      ...
      cumulativeBonus: { text: 'No Cumulative Bonus. Instead, offers Loyalty Bonus of 10% SI every year on renewal, max 100% SI.' },
      chronicDisease: { text: 'Covered after standard PED waiting period of 36 months.' },
      maternity: { text: 'Includes cover for Assisted Reproduction Treatment up to ₹2L after a 36-month wait - Can be removed as it is added in Row 16' },
      newbornCover: { text: 'Covered from Day 16 up to 10% of SI (max ₹50,000), subject to mother being insured for 12 months.' },
      wellness: { text: 'The Insured can earn reward points and avail premiumdiscount up to 20% on the renewal premium by enrolling and achieving the wellness goal. ' },
      opdCover: { text: 'Not Covered' },
      otherBenefits: { text: 'Assisted Reproduction Treatment. Organ Donor Expenses. Domiciliary Hospitalization.' },
  ...
  },
  {
    ...
    features: {
      policyType: { text: 'Individual & Family Floater (must include one adult female)' },
      entryAge: { text: 'Adults: 18 - 75 years ; Dependent Children - 91 days to 25 years ; Surrogate Mother & Oocyte Donor: 25 - 35 years' },
      sumInsured: { text: '₹5L to ₹1 Crore' },
      premium: { text: 'Varies' },
      hospitalization: { text: 'In-patient hospitalization (for 5 Lac-1% of SI,10 Lac to 25 Lac -Any Room (Except Suite or above category,For 50 Lac or  1 Cr --Any Room)' },
      prePostHosp: { text: '60 days & 90 days (Actuals)' },
      dayCare: { text: 'All day care procedures covered.' },
      ...
      wellness: { text: 'The Insured can earn reward points and avail premium discount up to 10% on the renewal premium by enrolling and achieving the wellness goals.' },
      opdCover: { text: 'Covered only for women based on SI amount' },
      otherBenefits: { text: 'In Utero Fetal Surgery, Assisted Reproduction Treatment, Star Mother Cover, Bariatric Surgery (Waiting Period 2 years) AYUSH Organ Donor' },
      waitingPeriods: { text: 'Delivery: 12/24 months. Specific Diseases: 24 months. PED: 24 months. Cancer Cover: 180 Days. Initial Waiting Period: 30 days' },
      exclusions: { text: 'Cosmetic surgery, self-inflicted injuries, adventure sports etc.' },
      usps: { text: 'Daughter can continue as a dependent child if Unmarried and/or Un-employed beyond 25 years and max up to 30 years, and beyond 30 years she will be treated as an Adult. Pregnant women can also buy this policy by submitting the scan reports taken at star health specified scan centres during their 12th and 20th week of their pregnancy period. For Females, the continuity benefits accrued under this policy before marriage will also be considered for claims under the Maternity Section' },
      homecaretreatment: { text: 'Yes available' },
      ConsumablesCover: { text: 'In-built cover' },
    },
  },
  {
    ...
    features: {
      ...
      premium: { text: 'Varies.' },
      hospitalization: { text: 'Covered up to the specified limits based on SI, but with 30% co-payment on all admissible claims.' },
      prePostHosp: { text: '30 days/7% of the hospitalization expenses' },
      dayCare: { text: 'All day care procedures covered.' },
      ...
      otherBenefits: { text: 'Coverage for Modern Treatments, Cataract, Specific Procedures & other major surgeries' },
      annualhealthcheckup: { text: 'Available every year up to the limits specified based on the policy type' },
  ...
  },
  {
    ...
    features: {
      ...
      premium: { text: 'Varies' },
      hospitalization: { text: 'Private Single AC Room' },
      prePostHosp: { text: 'Not applicable (Benefit-based).' },
      dayCare: { text: 'Covered under indemnity part.' },
      restoreBenefit: { text: 'Not applicable.' },
      cumulativeBonus: { text: '5% SI every claim-free year to a max of up to 50% SI for Indemnity cover' },
      chronicDisease: { text: 'Specifically for cancer patients/survivors.' },
      maternity: { text: 'Not applicable.' },
      newbornCover: { text: 'Not applicable.' },
      wellness: { text: 'Wellness Services are available' },
      opdCover: { text: 'Not applicable.' },
      otherBenefits: { text: 'AYUSH, Hospice Care, Modern Treatments, Lump Sum Payout on first diagnosis of recurrence/metastasis' },
      waitingPeriods: { text: 'Initial waiting period of 30 days. Specific waiting period of 24 months & PED Waiting Period: 30 months.' },
  ...
  },
  {
    ...
    features: {
      ...
      wellness: { text: 'Not applicable.' },
      opdCover: { text: 'Not applicable.' },
      otherBenefits: { text: 'Accidental Death: 100% of SI. Permanent Total Disablement: Up to 150% of SI. Temporary Total Disablement: Weekly payout of 1% of SI. Education Grant. Permanent Partial Disablement: Differs based on the disability' },
  ...
  },
  {
    ...
    features: {
      policyType: { text: 'Individual &  Floater' },
      entryAge: { text: 'Individual : 91 days to Max 75 Years ; Floater : Min 18 Years to Max 75 Years, Dependent Children: Min 16 Days to 25 years.' },
      sumInsured: { text: '5L to 2 Crores' },
      premium: { text: 'Starts from Rs.9903/year for 10 L cover' },
      hospitalization: { text: 'In-patient hospitalization [for 5 Lac-1% of SI,10 Lac to 25 Lac -Any Room (Except Suite or above category), For 50 Lac or 1 Cr -Any Room' },
      prePostHosp: { text: ' 60 days pre / 180 days post' },
      dayCare: { text: 'All day care procedures covered.' },
      restoreBenefit: { text: 'Sum Insured will be restored unlimited number of times and maximum up to 100% each time, which can be utilized for a subsequent hospitalization which can be used for all claims' },
      cumulativeBonus: { text: '25% of sum insured for each claim free year and maximum up to 100% of the sum insured' },
      chronicDisease: { text: 'Not Applicable ' },
      maternity: { text: '10% Of Sum insured. ' },
      newbornCover: { text: 'Yes covered' },
      wellness: { text: 'Premium discount upto 20% on renewal for maintaining good health.' },
      opdCover: { text: 'Unlimited Chat , Tele and video consultations through Star health App' },
      otherBenefits: { text: 'In Utero fetal surgery/Intervention, Rehablitation and Pain management for Post hospitalization care, Home care treatment, No day limit for Shared accomadation, Treatment for Chronic severe refractary asthma ( Can be treated through OPD, IPD, Day care,Home care ), Assistant reproductive treatment with less waiting period ( 2 years )' },
      waitingPeriods: { text: 'Initial: 30 days. Specified Diseases: 24 months. PED: 36 months. PED waiting period  can be reduced from 36 to 30 months by option 3 years policy.' },
      exclusions: { text: 'Cosmetic surgery, self-inflicted injuries, adventure sports etc' },
      usps: { text: 'Upto 4 parents can be added to the policy. Women centric benefits: High coverage for maternity, New born baby cover, In-utero fetal interventions.  Rehab and pain management for post hospitalization care,  Flagship plan built with affordable premium. upto 55% discount by choosing aggregate deductible(works well when we have another coverage already like Corporate policy holders).' },
      annualhealthcheckup: { text: 'Expenses incurred towards cost of health check-up up to the limits mentioned from day 1 for each policy year ' },
      cashbenefits: { text: 'Up to 1% of SI to a max of ₹5,000 per policy year for treatments in VSPs' },
      hospitalcashbenefit: { text: 'Rs. 1000/- Cash Benefit for in-patient hospitalization for each continuous and completed period of 24 hours of stay shared accommodation' },
  ...
  },
  {
    ...
    features: {
      policyType: { text: 'Individual & Family Floater' },
      entryAge: { text: 'Adults (18–any age), Children (91 days–25 years)' },
      sumInsured: { text: '5L to 1 Crore/Unlimited SI' },
      ...
      waitingPeriods: { text: 'Initial waiting period of 30 days. Specific waiting period of 24 months & PED Waiting Period: 36 months' },
      exclusions: { text: 'Standard exclusions apply' },
      usps: { text: 'Freeze your age, Premium waiver benefit, Dental Check-up and Scaling, Value Added Services' },
      hometcaretreatment: { text: 'Covered up to SI' },
      annualhealthcheckup: { text: 'Add-on feature (PHC)' }
  ...
  },
  {
    ...
    features: {
      policyType: { text: 'Individual & Family Floater' },
      entryAge: { text: 'Adult - 18 to any age,  Children (91 days–25 years)' },
      sumInsured: { text: '7.5L to 1 Crore' },
      deductible: { text: '₹25k, ₹50k, ₹1L' },
      hospitalization: { text: 'Covered Up to SI Room Rent: Any room Category' },
      prePostHosp: { text: '90 Days Pre and 180 Days Post' },
      premium: { text: 'Affordable premium with various discounts and Flexible deductible options' },
      dayCare: { text: 'All day care covered' },
      ...
      hometcaretreatment: { text: 'Yes available' },
      PremiumWaiver: { text: 'One year premium is waived if the proposer, who is also insured, is diagnosed with a listed critical illness or dies due to an accident' },
      FreezeyourAge: { text: 'Insured will pay premium as per the entry age till the first claim or till 56 yrs of age' },
      LimitlessLoyaltyBonus: { text: '100% Additional Sum Insured for each renewel (Irrespective of claim) with out any upper limit' },
      SumInsuredMultiplier: { text: 'Insured can combine & utilize the annual Sum Insured of base policy across the policy term. Applicable only for long term policies' },
      HealthBooster: { text: '100% of base Sum Insured is additionally provided, for every block of 7 claim free years' },
      NursingatHome: { text: 'Rs.1,000 per day, maximum up to 10 days in a policy year ' },
      ConsumablesCover: { text: '68 Non-payable items will be covered.' },
      GracePeriodCover: { text: 'Coverage available during the grace period for policies due for renewal' },
      StayFit: { text: 'Available as Add-on - Insured aged 18 years to 60yrs can avail visits to the ‘fitness centers’ (gyms and fitness studios) ' },
      InclinicConsultation: { text: 'Available as Add-on - In-person consultation with general physicians & Specialists ' },
      FutureShield: { text: 'Provides continuity benefit for all waiting periods served by the insured member to the spouse added if added within 120days from date of Marriage' },
      Limitlesscare: { text: 'Add-on' },
      annualhealthcheckup: { text: 'Preventive Health Check-up Add-on' }
  ...
  // --- Competitor Policies ---
  {
    ...
    features: {
      policyType: { text: 'Individual & Family Floater' },
      entryAge: { text: 'Adult: 18-lifelong; Child: 90 days-24 years' },
  ...
  },
  {
    ...
    features: {
      ...
      prePostHosp: { text: '30 days/60 days' },
      ...
      waitingPeriods: { text: 'Initial: 30 days. Named Ailments: 24 months. PED: 36 months.' },
  ...
  },
  {
    ...
    features: {
      ...
      sumInsured: { text: '3L to 10 Crores' },
      ...
      otherBenefits: { text: 'Please check once again on dental & vision coverages.' },
      waitingPeriods: { text: 'Initial waiting period is applicable - Check for specified & ped as well' },
  ...
  },
  {
    ...
    features: {
      ...
      hospitalization: { text: 'Room Options up to Sum Insured - 3L - 1. Shared Room 2. Single Private A/C Room ; 4L and above - 1. Shared Room 2. Single Private A/C Room 3. Any Room ; ICU charges covered up to Sum Insured.' },
      prePostHosp: { text: '60 days pre / 180 days post' },
  ...
  },
  {
    ...
    features: {
      policyType: { text: 'Individual/Multi-individual/Floater Types' },
      entryAge: { text: 'Adult: 18+; Child: 91 days-25 years' },
      sumInsured: { text: 'Advantage: ₹5L to ₹1 Crore' },
      premium: { text: 'Indicative for Advantage plan with ₹5L SI is ₹14,915/year' },
      hospitalization: { text: 'Private Single AC Room with ICU covered up to SI' },
      prePostHosp: { text: '60 days pre / 180 days post' },
  ...
  },
  {
    ...
    features: {
      ...
      prePostHosp: { text: '90 days/60 days or 90 days/200 days, based on SI' },
      dayCare: { text: 'All day-care treatments covered' },
      ...
      chronicDisease: { text: 'Covered after standard PED waiting period of 36 months.' },
      maternity: { text: 'Up to ₹50,000/₹1,00,000 (₹60,000/₹1,20,000 for a girl child) after a 36-month waiting period.' },
      newbornCover: { text: 'Covered up to ₹25,000 based on SI. Vaccination cover up to ₹10,000 (₹15,000 for girl child).' },
      ...
      opdCover: { text: 'OPD Dental Treatment: Up to ₹25,000 & High-End Diagnostics (OPD): Up to ₹50,000/year based on SI' },
      ...
      waitingPeriods: { text: 'Initial: 30 days. Specific Diseases: 24 months. PED: 24 months. Maternity: 36 months.' },
  ...
  },
  {
    ...
    features: {
      policyType: { text: 'Individual & Family Floater' },
      entryAge: { text: 'Adult: 6-65; Child: 91 days-25 years' },
      sumInsured: { text: '3L to 3 Crore' },
      premium: { text: 'Indicative for 25-year-old for ₹5L SI is ₹7,786/year' },
      hospitalization: { text: 'In-patient hospitalization: For up to 4 Lac-1% of SI ; 5 Lac & above - No capping on the room rent' },
      prePostHosp: { text: '60 days pre / 180 days post' },
      dayCare: { text: 'All day care procedures covered' },
      ...
      opdCover: { text: 'Part of optional BeFit Cover.' },
      ...
      waitingPeriods: { text: 'Initial: 30 days. Specific Diseases: 24 months. PED: 24 months. Bariatric Surgery: 24 months.' },
      exclusions: { text: 'Standard exclusions apply.' },
      usps: { text: 'Very High Sum Insured up to ₹3 Crore. Optional Worldwide Cover for higher SI plans. Short PED Waiting Period of 24 months. Guaranteed Cumulative Bonus of 20%.' },
    },
  },
  {
    ...
    features: {
      policyType: { text: 'Individual & Family Floater' },
      entryAge: { text: 'Adult: 18-lifelong; Child: 3 months-30 years' },
  ...
  },
  {
    ...
    features: {
      ...
      hospitalization: { text: 'Single Private A/C Room for SI ₹5L-₹7.5L; Any Room for SI ≥ ₹10L.' },
      prePostHosp: { text: '60 days pre / 90 days post' },
      dayCare: { text: '399 day care procedures covered' },
