...
export const policies: Policy[] = [
  ...
  },
  {
    ...
    features: {
      ...
      opdCover: { text: 'Not Covered' },
      otherBenefits: { text: 'Assisted Reproduction Treatment. Organ Donor Expenses. Domiciliary Hospitalization. Modern Treatments.' },
  ...
  },
  {
    ...
    features: {
      ...
      maternity: { text: 'Available as Add-on 50k/1L coverage with 2yrs waiting perion' }, newbornCover: { text: 'Yes with Maternity Rider' },
      ...
      LimitlessLoyaltyBonus: { text: '100% Additional Sum Insured for each renewal (Irrespective of claim) with out any upper limit' },
