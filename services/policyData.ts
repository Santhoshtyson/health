...
export const policies: Policy[] = [
  // --- Star Health Policies ---
  {
    ...
    features: {
      ...
      sumInsured: { text: '10L to 1 Crore' },
      ...
      cumulativeBonus: { text: 'For SI 7.5L & Above : 100% of base SI after one claim-free year. For SI of 5L: 50% per year, max 100%.' },
  ...
  },
  {
    ...
    features: {
      ...
      maternity: { text: 'payable up-to Rs.30,000 per delivery.' },
      newbornCover: { text: 'Not covered.' },
      wellness: { text: 'The Insured can earn reward points and avail premiumdiscount up to 10%on the renewal premium by enrolling and achieving the wellness goal. Annual Health Check-up: once after each policy year' },
      opdCover: { text: 'Not Covered' },
      otherBenefits: { text: 'RTA, 25% of sum insured subject to a max up/ Discount of Early Entry/Hospital Cash/E Medical Opinion' },
      ...
      hospitalcashbenefit: { text: 'Rs.1,000 per day, Maximum 7days per admission, 14 days per policy period' },
